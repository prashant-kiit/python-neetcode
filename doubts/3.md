...
Single-threaded async (asyncio)
Multi-threading (threading or concurrent.futures.ThreadPoolExecutor)
Multi-processing (multiprocessing) (for CPU-bound tasks)

Advanced Python topics like decorator?
